'''Packer connection plugin for Ansible 2.6.x

See: <https://raw.githubusercontent.com/hashicorp/packer/master/examples/ansible/connection-plugin/2.6.x/packer.py>'''
